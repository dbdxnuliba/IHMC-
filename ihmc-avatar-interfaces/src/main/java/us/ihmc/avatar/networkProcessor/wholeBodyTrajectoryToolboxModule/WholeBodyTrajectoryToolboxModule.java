...
public class WholeBodyTrajectoryToolboxModule extends ToolboxModule
{
   ...
   public WholeBodyTrajectoryToolboxModule(DRCRobotModel robotModel, boolean startYoVariableServer) throws IOException
   {
   ...
   public void registerExtraPuSubs(RealtimeRos2Node realtimeRos2Node)
   {
      ...
      ROS2Tools.createCallbackSubscription(realtimeRos2Node, CapturabilityBasedStatus.class, controllerPubGenerator, s -> {
         if (wholeBodyTrajectoryToolboxController != null)
            wholeBodyTrajectoryToolboxController.updateCapturabilityBasedStatus(s.takeNextData());
      });
   }
}