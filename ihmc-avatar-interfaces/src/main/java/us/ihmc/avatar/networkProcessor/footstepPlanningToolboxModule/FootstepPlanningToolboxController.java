...
public class FootstepPlanningToolboxController extends ToolboxController
{
   ...
   public FootstepPlanningToolboxController(RobotContactPointParameters<RobotSide> contactPointParameters, BipedFootstepPlannerParametersReadOnly footstepPlannerParameters,
   ...
   private AStarFootstepPlanner createAStarPlanner(SideDependentList<ConvexPolygon2D> footPolygons)
   {
      ...
      DistanceAndYawBasedHeuristics heuristics = new DistanceAndYawBasedHeuristics(footstepPlanningParameters.getCostParameters().getAStarHeuristicsWeightProvider(), footstepPlanningParameters);
