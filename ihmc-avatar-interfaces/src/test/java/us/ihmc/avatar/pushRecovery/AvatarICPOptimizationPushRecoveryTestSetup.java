...
public abstract class AvatarICPOptimizationPushRecoveryTestSetup
{
   ...
   protected FootstepDataListMessage createTwoStepStandingFootstepMessage()
   {
      double scale = getSizeScale();

      FramePoint3D step1Location = new FramePoint3D(worldFrame, 0.0, -0.125, 0.0);
      FramePoint3D step2Location = new FramePoint3D(worldFrame, 0.0,  0.125, 0.0);
   ...
   protected FootstepDataListMessage createLongStepsForwardWalkingFootstepMessage()
   {
      double scale = getSizeScale();

      FramePoint3D step1Location = new FramePoint3D(worldFrame, 0.75, -0.125, 0.0);
      FramePoint3D step2Location = new FramePoint3D(worldFrame, 1.5,  0.125, 0.0);
      FramePoint3D step3Location = new FramePoint3D(worldFrame, 2.25, -0.125, 0.0);
      FramePoint3D step4Location = new FramePoint3D(worldFrame, 3.0,  0.125, 0.0);
      FramePoint3D step5Location = new FramePoint3D(worldFrame, 3.75, -0.125, 0.0);
      FramePoint3D step6Location = new FramePoint3D(worldFrame, 4.5,  0.125, 0.0);
