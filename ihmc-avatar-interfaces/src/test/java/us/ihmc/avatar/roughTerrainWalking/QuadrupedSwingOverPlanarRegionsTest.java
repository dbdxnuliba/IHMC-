...
public abstract class QuadrupedSwingOverPlanarRegionsTest implements MultiRobotTestInterface
{
   ...
   public void testSwingOverPlanarRegions() throws SimulationExceededMaximumTimeException
   {
      ...
      if (LOCAL_MODE)
      {
         swingOverPlanarRegionsVisualizer = new QuadrupedSwingOverPlanarRegionsVisualizer(drcSimulationTestHelper.getSimulationConstructionSet(), registry,
      ...
      for (int i = 1; i <= steps; i++)
      {
         ...
         swingStartPosition.set(stanceFootPosition);
         stanceFootPosition.set(swingEndPosition);
         swingEndPosition.set(footstepX, footstepY, 0.0);
         ...
         {
            maxSpeedDimensionless = swingOverPlanarRegionsTrajectoryExpander.expandTrajectoryOverPlanarRegions(swingStartPosition, swingEndPosition, 0.08, planarRegionsList, null);
         }
