...
public class SimulatedStereoREAModule
{
   ...
   private final Ros2Node ros2Node = ROS2Tools.createRos2Node(PubSubImplementation.FAST_RTPS, "stereoSimulationNode");

   private static final double defaultUpdateFrequency = 5.0;
   ...
   public void setPlanarRegionsListEnvironment(PlanarRegionsList planarRegionsListEnvironment)
   {
      simulatedStereoCamera.setPlanarRegionsEnvironment(planarRegionsListEnvironment);
   }
