...
public class KinematicsStreamingToolboxInputMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.KinematicsStreamingToolboxInputMessage>
{
   ...
   public final static int getCdrSerializedSize(controller_msgs.msg.dds.KinematicsStreamingToolboxInputMessage data, int current_alignment)
   {
      ...
      current_alignment += controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.getCdrSerializedSize(data.getHeadInput(), current_alignment);

      current_alignment += controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.getCdrSerializedSize(data.getLeftHandInput(), current_alignment);

      current_alignment += controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.getCdrSerializedSize(data.getRightHandInput(), current_alignment);
   ...
   public static void write(controller_msgs.msg.dds.KinematicsStreamingToolboxInputMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.write(data.getHeadInput(), cdr);
      controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.write(data.getLeftHandInput(), cdr);
      controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.write(data.getRightHandInput(), cdr);
   }
   ...
   public static void read(controller_msgs.msg.dds.KinematicsStreamingToolboxInputMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.read(data.getHeadInput(), cdr);	
      controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.read(data.getLeftHandInput(), cdr);	
      controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType.read(data.getRightHandInput(), cdr);	
   ...
   public final void serialize(controller_msgs.msg.dds.KinematicsStreamingToolboxInputMessage data, us.ihmc.idl.InterchangeSerializer ser)
   {
      ...
      ser.write_type_a("head_input", new controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType(), data.getHeadInput());

      ser.write_type_a("left_hand_input", new controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType(), data.getLeftHandInput());

      ser.write_type_a("right_hand_input", new controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType(), data.getRightHandInput());
   ...
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, controller_msgs.msg.dds.KinematicsStreamingToolboxInputMessage data)
   {
      ...
      ser.read_type_a("head_input", new controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType(), data.getHeadInput());

      ser.read_type_a("left_hand_input", new controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType(), data.getLeftHandInput());

      ser.read_type_a("right_hand_input", new controller_msgs.msg.dds.KinematicsToolboxRigidBodyMessagePubSubType(), data.getRightHandInput());
