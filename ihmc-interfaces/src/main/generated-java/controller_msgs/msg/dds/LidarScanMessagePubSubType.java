...
public class LidarScanMessagePubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.LidarScanMessage>
{
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);current_alignment += (300000 * 4) + us.ihmc.idl.CDR.alignment(current_alignment, 4);
...
//      System.out.println(data.getScan().size());
      if(data.getScan().size() <= 300000)
