...
public class QuadrupedUIMessagerAPI
{
   ...
   private static final TypedTopicTheme<PawStepPlanningResult> PlanningResult = apiFactory.createTypedTopicTheme("PlanningResult");
   private static final TypedTopicTheme<PawStepPlannerStatus> PlannerStatus = apiFactory.createTypedTopicTheme("PlannerStatus");
   ...
   private static final TypedTopicTheme<PawStepPlannerTargetType> FootstepPlannerTargetType = apiFactory.createTypedTopicTheme("FootstepPlannerTargetType");
   ...
   /* Footstep Planning */
   public static final Topic<PawStepPlannerType> PlannerTypeTopic = Root.child(FootstepPlanning).child(Command).topic(Type);
   ...
   public static final Topic<PawStepPlanningResult> PlanningResultTopic = Root.child(FootstepPlanning).child(Result).topic(PlanningResult);
   public static final Topic<PawStepPlannerStatus> PlannerStatusTopic = Root.child(FootstepPlanning).child(Status).topic(PlannerStatus);
   public static final Topic<PawStepPlan> FootstepPlanTopic = Root.child(FootstepPlanning).child(Result).topic(FootstepPlan);
   ...
   public static final Topic<PawStepPlannerTargetType> StartTargetTypeTopic = Root.child(FootstepPlanning).child(Command).child(Start).child(Position).topic(FootstepPlannerTargetType);
