...
public class QuadrupedUIMessageConverter
{
   ...
   private IHMCRealtimeROS2Publisher<QuadrupedTeleopMessage> desiredTeleopVelocityPublisher;
...
//      ROS2Tools.createCallbackSubscription(ros2Node, WalkingControllerPreviewOutputMessage.class, controllerPreviewOutputTopicNameGenerator, s -> messager.submitMessage(QuadrupedUIMessagerAPI.WalkingPreviewOutput, s.takeNextData()));
      ...
      desiredTeleopVelocityPublisher = ROS2Tools.createPublisher(ros2Node, QuadrupedTeleopMessage.class, controllerSubGenerator);
   ...
   public void publishDesiredVelocity(QuadrupedTeleopMessage desiredVelocity)
   {
