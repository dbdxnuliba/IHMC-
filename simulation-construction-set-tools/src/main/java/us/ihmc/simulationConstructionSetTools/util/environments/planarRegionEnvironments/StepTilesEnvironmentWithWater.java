...
public class StepTilesEnvironmentWithWater extends PlanarRegionEnvironmentInterface
{
   private CombinedTerrainObject3D water;

   public StepTilesEnvironmentWithWater(double footWidth, double footLenght, double stepWidth, double stepLength, int numberOfSteps)
   {
         ...
         for (int i = 0; i < numberOfSteps; i++)
         {
            ...
            stepWidth = -stepWidth;
            water.addBox(-0.5 * footLenght + tilePositionX, 0.5 * footWidth + tilePositionY, 0.5 * footLenght + tilePositionX, -0.5 * footWidth + tilePositionY,
                         0.001, texture);
         }
   }
