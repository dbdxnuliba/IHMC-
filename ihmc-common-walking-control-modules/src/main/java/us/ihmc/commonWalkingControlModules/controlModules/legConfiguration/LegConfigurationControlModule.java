...
public class LegConfigurationControlModule
{
   ...
   private final YoDouble defaultDesiredAngleWhenStraight;
                                        ...
                                        LegConfigurationParameters legConfigurationParameters, YoVariableRegistry parentRegistry)
   {
      ...
      defaultDesiredAngleWhenStraight = new YoDouble(namePrefix + "DefaultDesiredAngleWhenStraight", registry);
      defaultDesiredAngleWhenStraight.set(legConfigurationParameters.getKneeAngleWhenStraight());
      ...
      desiredAngleWhenStraight.set(defaultDesiredAngleWhenStraight.getDoubleValue());
   ...
   public void setDesiredAngleWhenStraight(double angle){desiredAngleWhenStraight.set(angle);}

   public YoDouble getDefaultDesiredAngleWhenStraight(){return  defaultDesiredAngleWhenStraight;}
   ...
   private class BentKneeControlState implements State
   {
      ...
      public void onEntry()
      {
         legControlWeight.set(LegControlWeight.HIGH);
      }
