...
public class WholeBodyControlCoreToolbox
{
   ...
   {
      this("", controlDT, gravityZ, rootJoint, controlledJoints, centerOfMassFrame, controllerCoreOptimizationSettings, yoGraphicsListRegistry, parentRegistry);
   }
    ...
    */
   public WholeBodyControlCoreToolbox(String namePrefix, double controlDT, double gravityZ, FloatingInverseDynamicsJoint rootJoint,
                                      InverseDynamicsJoint[] controlledJoints, ReferenceFrame centerOfMassFrame,
   ...
   public WrenchVisualizer getWrenchVisualizer()
   {
      if (wrenchVisualizer == null)
         wrenchVisualizer = createWrenchVisualizerWithContactableBodies(namePrefix + "DesiredExternalWrench", contactablePlaneBodies, 1.0,
