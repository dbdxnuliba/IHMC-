                                                                      ...
                                                                      int alphaCoMDerivativeOrder, Trajectory cmpPolynomial)
   {
      ...
      for (int i = 0; i < numberOfCoefficients; i++)
      {
         for (int j = i; j < numberOfCoefficients; j++)
         {
            ...
            CommonOps.addEquals(generalizedAlphaCoMPrimeRow, scalar, cmpPolynomial.evaluateGeometricPolynomialDerivative(j + alphaCoMDerivativeOrder, time));
         }
      }
   }
   ...
   {                        
      ...
      for (int i = 0; i < numberOfCoefficients; i++)
      {
         for (int j = i; j < numberOfCoefficients; j++)
         {
            ...
            CommonOps.addEquals(generalizedBetaCoMPrimeRow, scalar, cmpPolynomial.evaluateGeometricPolynomialDerivative(j, timeSegmentInitial));
         }
      }
   }
