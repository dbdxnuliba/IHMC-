...
public class ConstraintMatrixHandler
{
   ...
   public void addInterSegmentScalarConstraint(int segmentIndex1, DenseMatrix64F segment1CoefficientMatrix,
                                               ...
                                               DenseMatrix64F segment2BiasMatrix)
   {
      ...
      tempMatrix.zero();
      CommonOps.addEquals(tempMatrix, segment1BiasMatrix);
      CommonOps.subtractEquals(tempMatrix, segment2BiasMatrix);
      b.reshape(numberOfRows + tempMatrix.getNumRows(), 1, true);
      CommonOps.insert(tempMatrix, b, numberOfRows, 0);
   }

   public void addInterSegmentCoPConstraint(Axis axis, int segmentIndex1, DenseMatrix64F segment1CoefficientMatrix,
                                            DenseMatrix64F segment1BiasMatrix, int segmentIndex2, DenseMatrix64F segment2CoefficientMatrix,
                                            DenseMatrix64F segment2BiasMatrix)
   {
      if (axis == Axis.Z)
   ...
   public void addInterSegmentCoMConstraint(Axis axis, int segmentIndex1, DenseMatrix64F segment1CoefficientMatrix,
                                            DenseMatrix64F segment1BiasMatrix, int segmentIndex2, DenseMatrix64F segment2CoefficientMatrix,
                                            DenseMatrix64F segment2BiasMatrix)
   {
      if (segment1CoefficientMatrix.getNumRows() != segment1BiasMatrix.getNumRows() || segment2CoefficientMatrix.getNumRows() != segment2BiasMatrix.getNumRows()
   ...
   public void addIntraSegmentScalarConstraint(int segmentIndex, DenseMatrix64F segmentCoefficentMatrix,
   ...
   public void addIntraSegmentCoPConstraint(Axis axis, int segmentIndex, DenseMatrix64F segmentCoefficentMatrix,
                                            DenseMatrix64F segmentBiasMatrix)
   {
      if (segmentCoefficentMatrix.getNumRows() != segmentBiasMatrix.getNumRows())
         throw new RuntimeException("Number of rows mismath in the specified constraint coefficient and bias matrices");
