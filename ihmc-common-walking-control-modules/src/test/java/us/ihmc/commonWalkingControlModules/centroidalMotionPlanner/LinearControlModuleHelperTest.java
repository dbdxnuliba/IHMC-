...
public class LinearControlModuleHelperTest
{
   ...
   {
      ControlModuleHelper helper = new ControlModuleHelper(parameters);
   ...
   private void testAxisOptimization(double epsilon, ControlModuleHelper helper, Axis axisToTest, double expectedForceValue, double expectedForceRateValue)
   {
