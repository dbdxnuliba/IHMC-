...
public class FootstepPlannerUI
{
   ...
   public FootstepPlannerUI(Stage primaryStage, BipedFootstepPlannerParametersReadOnly plannerParameters, VisibilityGraphsParameters visibilityGraphsParameters) throws Exception
   {
   ...
   public static FootstepPlannerUI createMessagerUI(Stage primaryStage, JavaFXMessager messager, BipedFootstepPlannerParametersReadOnly plannerParameters,
