...
public class SimpleOcclusionTests
{
   ...
   private class BestEffortPlannerParameters extends BipedFootstepPlannerParameters
   {
      @Override
   ...
   private void runTest(TestInfo testInfo, FramePose3D startPose, FramePose3D goalPose, PlanarRegionsList regions, BipedFootstepPlannerParametersReadOnly parameters,
...
//      PlanarRegionsList visiblePlanarRegions = new PlanarRegionsList();
   ...
   private RobotSide computeStanceFootPose(FramePose3D startPose, BipedFootstepPlannerParametersReadOnly parameters, FramePose3D stancePoseToPack)
   {
   ...
   private Point3D computeBodyPoint(FramePose3D solePose, RobotSide side, BipedFootstepPlannerParametersReadOnly parameters, double bodyHeight)
   {
      double stanceWidth = parameters.getIdealFootstepWidth();
   ...
   private FootstepPlanner getPlanner(BipedFootstepPlannerParametersReadOnly parameters, VisibilityGraphsParameters visibilityGraphsParameters,
   ...
   private BipedFootstepPlannerParametersReadOnly getParameters()
   {
      return new BipedFootstepPlannerParameters();
   }
