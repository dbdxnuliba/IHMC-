...
public class RemoteFootstepPlannerUIMessagingTest
{
   ...
   private void runPlanObjectivePackets()
   {
      ...
      for (int iter = 0; iter < iters; iter++)
      {
         BipedFootstepPlannerParametersReadOnly randomParameters = FootstepPlanningTestTools.createRandomParameters(random);
   ...
   private static void checkFootstepPlannerParameters(BipedFootstepPlannerParametersReadOnly parameters, FootstepPlannerParametersPacket packet)
   {
   ...
   private static void checkFootstepPlannerCostParameters(BipedFootstepPlannerCostParametersReadOnly parameters, FootstepPlannerCostParametersPacket packet)
   {
