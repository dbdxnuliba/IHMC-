...
public class ControllerBasedBodyPathTest
{
   ...
   private class Controller extends SimpleRobotController
   {
      ...
      private final BipedFootstepPlannerParametersReadOnly parameters = new DefaultFootstepPlanningParameters();
      ...
      private AStarFootstepPlanner createBodyPathBasedPlanner(YoVariableRegistry registry, BipedFootstepPlannerParametersReadOnly parameters,
