...
public class FootstepPlannerMessagerAPI
{
   ...
   private static final TypedTopicTheme<BipedFootstepPlannerParametersReadOnly> FootstepPlannerParameters = apiFactory.createTypedTopicTheme("FootstepPlannerParameters");
   ...
   public static final Topic<BipedFootstepPlannerParametersReadOnly> PlannerParametersTopic = Root.child(Parameters).topic(FootstepPlannerParameters);
