...
public class PlanarRegionBaseOfCliffAvoider extends FootstepNodeChecker
{
   ...
   public PlanarRegionBaseOfCliffAvoider(BipedFootstepPlannerParametersReadOnly parameters, FootstepNodeSnapperReadOnly snapper, SideDependentList<ConvexPolygon2D> footPolygons)
   {
