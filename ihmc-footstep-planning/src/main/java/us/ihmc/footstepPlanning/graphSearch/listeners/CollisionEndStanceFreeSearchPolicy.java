...
public class CollisionEndStanceFreeSearchPolicy implements PlannerHeuristicNodeSearchPolicy, StartAndGoalListener
{
   ...
   public CollisionEndStanceFreeSearchPolicy(BodyCollisionNodeChecker collisionNodeChecker, FootstepNodeSnapper snapper, BipedFootstepPlannerParametersReadOnly parameters)
   {
