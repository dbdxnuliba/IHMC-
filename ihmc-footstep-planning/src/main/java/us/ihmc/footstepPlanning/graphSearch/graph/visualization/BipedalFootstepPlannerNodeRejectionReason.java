...
public enum BipedalFootstepPlannerNodeRejectionReason
{
   ...
   STEP_IN_PLACE, NOT_ENOUGH_AREA, COULD_NOT_SNAP, COULD_NOT_WIGGLE_INSIDE, SURFACE_NORMAL_TOO_STEEP_TO_SNAP, TOO_MUCH_PENETRATION_AFTER_WIGGLE, STEP_NOT_LONG_ENOUGH, STEP_TOO_WIDE, OBSTACLE_HITTING_ANKLE, OBSTACLE_HITTING_BODY, AT_CLIFF_BOTTOM;
