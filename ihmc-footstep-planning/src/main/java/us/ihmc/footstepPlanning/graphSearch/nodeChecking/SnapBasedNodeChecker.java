...
public class SnapBasedNodeChecker extends FootstepNodeChecker
{
   ...
   public SnapBasedNodeChecker(BipedFootstepPlannerParametersReadOnly parameters, SideDependentList<ConvexPolygon2D> footPolygons, FootstepNodeSnapper snapper)
   {
