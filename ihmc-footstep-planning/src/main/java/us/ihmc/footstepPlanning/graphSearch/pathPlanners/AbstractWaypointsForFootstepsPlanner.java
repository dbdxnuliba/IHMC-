...
public abstract class AbstractWaypointsForFootstepsPlanner implements WaypointsForFootstepsPlanner
{
   ...
   protected final BipedFootstepPlannerParametersReadOnly parameters;
   ...
   public AbstractWaypointsForFootstepsPlanner(BipedFootstepPlannerParametersReadOnly parameters, YoVariableRegistry registry)
   {
      this("", parameters, registry);
   }

   public AbstractWaypointsForFootstepsPlanner(String prefix, BipedFootstepPlannerParametersReadOnly parameters, YoVariableRegistry registry)
   {
