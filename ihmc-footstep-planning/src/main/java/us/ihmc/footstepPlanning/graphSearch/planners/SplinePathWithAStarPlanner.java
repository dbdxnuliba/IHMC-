...
public class SplinePathWithAStarPlanner extends BodyPathAndFootstepPlannerWrapper
{
   ...
   public SplinePathWithAStarPlanner(BipedFootstepPlannerParametersReadOnly parameters, SideDependentList<ConvexPolygon2D> footPolygons, YoVariableRegistry parentRegistry,
