...
public class YoFootstepPlannerParameters implements BipedFootstepPlannerParametersReadOnly
{
   ...
   public YoFootstepPlannerParameters(YoVariableRegistry parentRegistry, BipedFootstepPlannerParametersReadOnly defaults)
   {
   ...
   public void set(BipedFootstepPlannerParametersReadOnly defaults)
   {
