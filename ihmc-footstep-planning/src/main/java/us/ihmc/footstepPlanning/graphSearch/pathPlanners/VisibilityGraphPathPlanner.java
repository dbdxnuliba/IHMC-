...
public class VisibilityGraphPathPlanner extends AbstractWaypointsForFootstepsPlanner
{
   ...
   public VisibilityGraphPathPlanner(BipedFootstepPlannerParametersReadOnly footstepPlannerParameters, VisibilityGraphsParameters visibilityGraphsParameters,
   ...
   public VisibilityGraphPathPlanner(String prefix, BipedFootstepPlannerParametersReadOnly footstepPlannerParameters, VisibilityGraphsParameters visibilityGraphsParameters,
                                     YoVariableRegistry parentRegistry)
   {
