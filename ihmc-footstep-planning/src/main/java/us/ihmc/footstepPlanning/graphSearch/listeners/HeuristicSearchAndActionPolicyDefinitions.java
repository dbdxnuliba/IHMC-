...
public class HeuristicSearchAndActionPolicyDefinitions
{
   ...
   private final RequiredFactoryField<BipedFootstepPlannerParametersReadOnly> parameters= new RequiredFactoryField<>("parameters");
   ...
   public void setParameters(BipedFootstepPlannerParametersReadOnly parameters)
   {
