...
public class EnoughAreaSnapChecker implements SnapBasedCheckerComponent
{
   ...
   public EnoughAreaSnapChecker(BipedFootstepPlannerParametersReadOnly parameters, SideDependentList<ConvexPolygon2D> footPolygons, FootstepNodeSnapper snapper)
   {
