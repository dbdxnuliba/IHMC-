...
public class FootstepNodeSnapAndWiggler extends FootstepNodeSnapper
{
   ...
   public FootstepNodeSnapAndWiggler(SideDependentList<ConvexPolygon2D> footPolygonsInSoleFrame, BipedFootstepPlannerParametersReadOnly parameters)
   {
      this(footPolygonsInSoleFrame, parameters, null);
   }

   public FootstepNodeSnapAndWiggler(SideDependentList<ConvexPolygon2D> footPolygonsInSoleFrame, BipedFootstepPlannerParametersReadOnly parameters, FootstepNodeBodyCollisionDetector collisionDetector)
   {
