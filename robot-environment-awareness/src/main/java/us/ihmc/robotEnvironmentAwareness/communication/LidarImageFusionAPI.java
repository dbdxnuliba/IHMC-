...
public class LidarImageFusionAPI
{
   ...
   public static final Topic<SuperPixelNormalEstimationParameters> SuperPixelNormalEstimationParameters = UICategory.child(NormalEstimation).topic(Parameters);
