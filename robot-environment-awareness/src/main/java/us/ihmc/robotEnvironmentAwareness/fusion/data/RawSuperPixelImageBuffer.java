...
import us.ihmc.robotEnvironmentAwareness.fusion.dataFactory.RawSuperPixelImageFactory;
import us.ihmc.robotEnvironmentAwareness.fusion.tools.PointCloudProjectionHelper;
import us.ihmc.robotEnvironmentAwareness.fusion.dataFactory.SuperPixelGridImageFactory;
...
public class RawSuperPixelImageBuffer
{
   ...
   public RawSuperPixelImageBuffer(Messager messager, IntrinsicParameters intrinsic)
   {
...
//      latestCameraIntrinsicParameters = messager.createInput(LidarImageFusionAPI.CameraIntrinsicParametersState, new IntrinsicParameters());
   ...
   {
      newBuffer.set(updateNewBuffer(latestStereoVisionPointCloudMessage.getAndSet(null)));
   }
